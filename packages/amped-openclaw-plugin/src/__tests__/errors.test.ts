...
describe('Error Utilities', () => {
  describe('AmpedOpenClawError', () => {
    it('should create error with all properties', () => {
      const error = new AmpedOpenClawError(
      ...
      expect(error.name).toBe('AmpedOpenClawError');
    });
  ...
  describe('wrapError', () => {
    it('should return AmpedOpenClawError as-is', () => {
      const original = new AmpedOpenClawError(
    ...
    it('should wrap standard Error and infer code', () => {
      ...
      expect(wrapped).toBeInstanceOf(AmpedOpenClawError);
  ...
  describe('isRetryableError', () => {
    it('should identify retryable error codes', () => {
      const timeoutError = new AmpedOpenClawError(
        ErrorCode.TRANSACTION_TIMEOUT,
        'Timeout'
      );
      expect(isRetryableError(timeoutError)).toBe(true);

      const rpcError = new AmpedOpenClawError(
    ...
    it('should identify non-retryable error codes', () => {
      const policyError = new AmpedOpenClawError(
        ErrorCode.POLICY_SLIPPAGE_EXCEEDED,
        'Slippage'
      );
  ...
  describe('logError', () => {
    it('should log structured error', () => {
      ...
      expect(logged.component).toBe('amped-openclaw');
